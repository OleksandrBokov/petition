...
//                        echo "</pre>";
                        ...
                        <div class="votes" id="votes">
                            ...
                            <?php elseif(null === $userVote && (Yii::app()->user->role === User::ROLE_USER || Yii::app()->user->role === User::ROLE_MODERATOR)): ?>
                                <?php
                                ...
                                ?>
                                <?php echo $form->hiddenField($petition, 'id'); ?>
                                <?php echo CHtml::ajaxSubmitButton(Yii::t('main','підпісати петицію'),CHtml::normalizeUrl(array(Yii::app()->createUrl('/'))),
                                    array(
                                        'dataType'=>'json',
                                        'type'=>'post',
                                    ...
                                    ),array('class'=>'btn btn-success', 'type'=>'button','method'=>'post'/*, 'disabled'=>'disabled'*/)); ?>
                                <?php $this->endWidget(); ?>
                            <?php elseif(null !== $userVote && (Yii::app()->user->role === User::ROLE_USER || Yii::app()->user->role === User::ROLE_MODERATOR)): ?>
                                <div class="vote-mssg">Ваш підпис вже зараховано</div>
                            <?php else: ?>
