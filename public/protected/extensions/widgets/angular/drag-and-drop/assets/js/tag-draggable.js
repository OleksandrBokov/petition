...
angular.module("tagDraggable", []).controller('tag-draggable',['$scope',  function($scope){
    ...
    return {
        restrict: 'AE',
        replace: true,
        templateUrl: 'tag-draggable.html',
...
new AppFactory("tag-draggable", "tagDraggableFactory", ["tagDraggable"]);
