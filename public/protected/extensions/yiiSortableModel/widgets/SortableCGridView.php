...
class SortableCGridView extends CGridView
{
   ...
   {
      return '
         var grid_id,grid_selector,tbody_selector;
          sortGrid();

          function sortGrid(){

             grid_id = '.Cjavascript::encode($this->getId()).';
             grid_selector = '.Cjavascript::encode('#'.$this->getId()).';
             tbody_selector = '.Cjavascript::encode('#'.$this->getId().' tbody').';
             /*apply sortable*/
             ...
             $(tbody_selector).bind("sortupdate", function(event, ui) {
                ...
                '.CHtml::ajax(array(
                      'type' => 'POST',
                      'url' => Yii::App()->controller->createUrl($this->orderUrl),
                      'data' => 'js:data',
                      'success' => 'js:function() {
